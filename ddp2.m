...
kappa = 0.5; % death rate due to antibiotics
...
%freq = 1/T, make it twice as frequent with half the death rate
T = 12*60*0.0051; % period of antibiotic dosing, doubling increases pop, halving decreases
...
k = kappa*ones(length(IC)-3,1); %<----- antibiotic resistance change to scaling to 0
...
%%
% Produces figure 6 after running the above code
...
ylim([0 .0005])
title('Double Frequency, Half Efficacy')
xlabel('time','FontSize',20)
ylabel('bacteria population size','FontSize',20)

...
kappa = 2; % death rate due to antibiotics
...
T = 48*60*0.0051; % period of antibiotic dosing, doubling increases pop, halving decreases
...
title('Half Frequency, Double Efficacy')
ylim([0 1])
